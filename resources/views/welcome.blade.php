...
<head>
    ...
    <link href="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-2.3.1/b-3.2.3/b-colvis-3.2.3/sp-2.3.3/datatables.min.css"
        rel="stylesheet" integrity="sha384-2BD9G3Ok8QLT3FzSEAOTeFywE2PMAbB0AGsP8FvAvacpQIMlFdMWwTvvVm0E75Rd"
        crossorigin="anonymous">

    <script src="https://cdn.datatables.net/v/bs5/jq-3.7.0/dt-2.3.1/b-3.2.3/b-colvis-3.2.3/sp-2.3.3/datatables.min.js"
        integrity="sha384-kGW7hcPMrEOXoWoNrKf7oFT3x52cYWiNiJq6802kfz5bGnjhackNojoNcaj7yz/P"
        ...
        <div class="max-w-7xl mx-auto p-6 lg:p-8">
            ...
            <div class="flex justify-center mt-16 px-0 sm:items-center sm:justify-between">
                ...
                <div class="ml-4 text-center text-sm text-gray-500 dark:text-gray-400 sm:text-right sm:ml-0">
                    &copy; {{ date('Y') }} Mudanzas Logística. Todos los derechos reservados.
                </div>
            </div>
        </div>
    </div>
